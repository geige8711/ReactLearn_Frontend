...
export const PRODUCT_CREATE_MULTIPLE_REQUEST =
  "PRODUCT_CREATE_MULTIPLE_REQUEST";
export const PRODUCT_CREATE_MULTIPLE_SUCCESS =
  "PRODUCT_CREATE_MULTIPLE_SUCCESS";
export const PRODUCT_CREATE_MULTIPLE_FAIL = "PRODUCT_CREATE_MULTIPLE_FAIL";
